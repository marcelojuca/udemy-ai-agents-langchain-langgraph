...
first_responder_chain = (
    actor_prompt_template.partial(first_instruction=first_responder_instructions) 
...
if __name__ == "__main__":
    ...
    print("--------------------------------")
    print("First response - reflection - missing:", res_first_response[0].reflection.missing)
    print("--------------------------------")
    print("First response - reflection - superfluous:", res_first_response[0].reflection.superfluous)
    print("--------------------------------")
